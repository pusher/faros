...
var gittracksResource = schema.GroupVersionResource{Group: "faros.pusher.com", Version: "v1alpha1", Resource: "gittracks"}

var gittracksKind = schema.GroupVersionKind{Group: "faros.pusher.com", Version: "v1alpha1", Kind: "GitTrack"}
...
func (c *FakeGitTracks) Get(name string, options v1.GetOptions) (result *v1alpha1.GitTrack, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(gittracksResource, c.ns, name), &v1alpha1.GitTrack{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.GitTrack), err
}
...
func (c *FakeGitTracks) List(opts v1.ListOptions) (result *v1alpha1.GitTrackList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(gittracksResource, gittracksKind, c.ns, opts), &v1alpha1.GitTrackList{})
	...
	list := &v1alpha1.GitTrackList{ListMeta: obj.(*v1alpha1.GitTrackList).ListMeta}
	for _, item := range obj.(*v1alpha1.GitTrackList).Items {
...
func (c *FakeGitTracks) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(gittracksResource, c.ns, opts))
...
func (c *FakeGitTracks) Create(gitTrack *v1alpha1.GitTrack) (result *v1alpha1.GitTrack, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(gittracksResource, c.ns, gitTrack), &v1alpha1.GitTrack{})
...
func (c *FakeGitTracks) Update(gitTrack *v1alpha1.GitTrack) (result *v1alpha1.GitTrack, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(gittracksResource, c.ns, gitTrack), &v1alpha1.GitTrack{})
...
func (c *FakeGitTracks) UpdateStatus(gitTrack *v1alpha1.GitTrack) (*v1alpha1.GitTrack, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(gittracksResource, "status", c.ns, gitTrack), &v1alpha1.GitTrack{})
...
func (c *FakeGitTracks) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(gittracksResource, c.ns, name), &v1alpha1.GitTrack{})
...
func (c *FakeGitTracks) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(gittracksResource, c.ns, listOptions)

	_, err := c.Fake.Invokes(action, &v1alpha1.GitTrackList{})
	return err
}
...
func (c *FakeGitTracks) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.GitTrack, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(gittracksResource, c.ns, name, pt, data, subresources...), &v1alpha1.GitTrack{})
