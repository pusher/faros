...
type Interface interface {
	...
	FarosV1alpha2() farosv1alpha2.FarosV1alpha2Interface
}
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	farosV1alpha2 *farosv1alpha2.FarosV1alpha2Client
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	cs.farosV1alpha2, err = farosv1alpha2.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	...
	cs.farosV1alpha2 = farosv1alpha2.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	...
	cs.farosV1alpha2 = farosv1alpha2.New(c)
