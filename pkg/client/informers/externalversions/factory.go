...
import (
	...
	faros "github.com/pusher/faros/pkg/client/informers/externalversions/faros"
...
type SharedInformerFactory interface {
	...
	Faros() faros.Interface
}

func (f *sharedInformerFactory) Faros() faros.Interface {
	return faros.New(f, f.namespace, f.tweakListOptions)
}
